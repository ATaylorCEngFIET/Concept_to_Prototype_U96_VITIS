...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_21_addr_arbiter_sasd is
  port (
    ...
    \gen_arbiter.m_amesg_i_reg[19]_0\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
    ...
    \m_axi_awvalid[1]\ : in STD_LOGIC_VECTOR ( 2 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_21_addr_arbiter_sasd is
  ...
  attribute SOFT_HLUTNM of \gen_arbiter.m_amesg_i[18]_i_2\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \m_axi_bready[7]_INST_0\ : label is "soft_lutpair44";
  ...
  attribute SOFT_HLUTNM of \m_axi_wvalid[7]_INST_0\ : label is "soft_lutpair44";
  ...
  attribute SOFT_HLUTNM of \s_axi_bresp[1]_INST_0_i_5\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \s_axi_bresp[1]_INST_0_i_6\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \s_axi_rvalid[1]_INST_0\ : label is "soft_lutpair40";
...
addr_arbiter_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_21_addr_arbiter_sasd
     port map (
      D(7) => addr_arbiter_inst_n_45,
      D(6 downto 0) => m_atarget_hot0(7 downto 1),
      E(0) => p_1_in,
      Q(42 downto 0) => Q(42 downto 0),
      SR(1) => reset,
      ...
      \gen_arbiter.m_amesg_i_reg[19]_0\(3) => any_error,
      \gen_arbiter.m_amesg_i_reg[19]_0\(2) => f_hot2enc_return0,
      \gen_arbiter.m_amesg_i_reg[19]_0\(1) => addr_arbiter_inst_n_102,
      \gen_arbiter.m_amesg_i_reg[19]_0\(0) => addr_arbiter_inst_n_103,
      \gen_axilite.s_axi_bvalid_i_reg\ => addr_arbiter_inst_n_157,
      \gen_axilite.s_axi_bvalid_i_reg_0\(7 downto 0) => m_atarget_hot(8 downto 1),
      ...
      m_axi_arready_2_sp_1 => addr_arbiter_inst_n_98,
      ...
      \m_axi_awvalid[1]\(2 downto 0) => m_ready_d_1(2 downto 0),
      m_axi_bready(6 downto 0) => m_axi_bready(6 downto 0),
      m_axi_bvalid(5 downto 0) => m_axi_bvalid(6 downto 1),
      \m_axi_bvalid[6]\ => addr_arbiter_inst_n_105,
      m_axi_bvalid_2_sp_1 => addr_arbiter_inst_n_111,
      m_axi_bvalid_4_sp_1 => addr_arbiter_inst_n_107,
      m_axi_wdata(31 downto 0) => m_axi_wdata(31 downto 0),
      m_axi_wready(7 downto 0) => m_axi_wready(7 downto 0),
      m_axi_wready_0_sp_1 => addr_arbiter_inst_n_104,
      m_axi_wready_2_sp_1 => addr_arbiter_inst_n_112,
      m_axi_wready_4_sp_1 => addr_arbiter_inst_n_108,
      m_axi_wready_6_sp_1 => addr_arbiter_inst_n_106,
      m_axi_wstrb(3 downto 0) => m_axi_wstrb(3 downto 0),
      m_axi_wvalid(6 downto 0) => m_axi_wvalid(6 downto 0),
      \m_payload_i_reg[0]\(0) => addr_arbiter_inst_n_88,
      ...
      m_valid_i_reg_0 => addr_arbiter_inst_n_55,
      ...
      s_ready_i_reg_2 => reg_slice_r_n_39,
      sr_rvalid => sr_rvalid
    );
...
\gen_decerr.decerr_slave_inst\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_21_decerr_slave
     port map (
      ...
      \f_mux_return__2\ => \f_mux_return__2\,
      \f_mux_return__6\ => \f_mux_return__6\,
      \gen_arbiter.m_grant_hot_i[1]_i_2\ => addr_arbiter_inst_n_97,
      \gen_arbiter.m_grant_hot_i[1]_i_2_0\ => addr_arbiter_inst_n_98,
      \gen_arbiter.m_grant_hot_i[1]_i_2_1\ => addr_arbiter_inst_n_99,
      ...
      \gen_axilite.s_axi_awready_i_reg_1\ => addr_arbiter_inst_n_157,
      ...
      \m_ready_d_reg[0]\ => addr_arbiter_inst_n_105,
      \m_ready_d_reg[0]_0\ => addr_arbiter_inst_n_111,
      ...
      \m_ready_d_reg[1]_2\ => addr_arbiter_inst_n_108,
      mi_arvalid_en => mi_arvalid_en,
      mi_bvalid(0) => mi_bvalid(8),
      mi_wready(0) => mi_wready(8),
...
reg_slice_r: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_register_slice_v2_1_20_axic_register_slice
     port map (
      ...
      \m_axi_rready[7]\(6 downto 0) => m_atarget_hot(7 downto 1),
      ...
      m_valid_i_reg_0 => addr_arbiter_inst_n_53,
      p_2_in => p_2_in,
      \s_ready_i0__1\(0) => \s_ready_i0__1\(0),
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_21_axi_crossbar is
  ...
  attribute C_M_AXI_ADDR_WIDTH of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_21_axi_crossbar : entity is "256'";
  attribute C_M_AXI_BASE_ADDR : string;
  attribute C_M_AXI_BASE_ADDR of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_21_axi_crossbar : entity is "512'";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute C_M_AXI_BASE_ADDR : string;
  attribute C_M_AXI_BASE_ADDR of inst : label is "512'";
  attribute C_M_AXI_READ_CONNECTIVITY : string;
