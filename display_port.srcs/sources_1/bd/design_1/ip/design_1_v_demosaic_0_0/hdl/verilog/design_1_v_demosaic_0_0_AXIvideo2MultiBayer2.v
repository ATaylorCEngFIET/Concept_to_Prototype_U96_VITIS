...
design_1_v_demosaic_0_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_309(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
design_1_v_demosaic_0_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_315(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state5) & (icmp_ln146_fu_330_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln149_reg_415 == 1'd0) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b0 == ap_block_pp1_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        axi_data_V_3_i_i_reg_277 <= s_axis_video_TDATA_int;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln149_fu_341_p2 == 1'd0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_187)) begin
        if (((or_ln153_fu_355_p2 == 1'd1) & (icmp_ln149_fu_341_p2 == 1'd0))) begin
            ...
            p_Val2_s_reg_252 <= s_axis_video_TDATA_int;
        end else if ((1'b1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if (((s_axis_video_TVALID_int == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
        tmp_data_V_reg_386 <= s_axis_video_TDATA_int;
        tmp_last_V_reg_394 <= s_axis_video_TLAST_int;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state5) & (icmp_ln146_fu_330_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((icmp_ln149_reg_415 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1))) begin
...
always @ (*) begin
    if (((~((eol_2_i_i_reg_289 == 1'd0) & (s_axis_video_TVALID_int == 1'b0)) & (eol_2_i_i_reg_289 == 1'd0) & (1'b1 == ap_CS_fsm_state9)) | ((ap_predicate_op121_read_state6 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001)) | ((s_axis_video_TVALID_int == 1'b1) & (1'b1 == ap_CS_fsm_state3)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((tmp_user_V_fu_321_p1 == 1'd0) & (s_axis_video_TVALID_int == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else if (((s_axis_video_TVALID_int == 1'b1) & (tmp_user_V_fu_321_p1 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        ...
        ap_ST_fsm_pp1_stage0 : begin
            if (~((icmp_ln149_fu_341_p2 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0_subdone))) begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end else if (((icmp_ln149_fu_341_p2 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0_subdone))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = (((s_axis_video_TVALID_int == 1'b0) & (ap_predicate_op121_read_state6 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)) | ((icmp_ln149_reg_415 == 1'd0) & (img_V_val_V_full_n == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = (((s_axis_video_TVALID_int == 1'b0) & (ap_predicate_op121_read_state6 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)) | ((icmp_ln149_reg_415 == 1'd0) & (img_V_val_V_full_n == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = (((s_axis_video_TVALID_int == 1'b0) & (ap_predicate_op121_read_state6 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)) | ((icmp_ln149_reg_415 == 1'd0) & (img_V_val_V_full_n == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state6_pp1_stage0_iter0 = ((s_axis_video_TVALID_int == 1'b0) & (ap_predicate_op121_read_state6 == 1'b1));
end
...
always @ (*) begin
    ap_condition_187 = ((ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001));
end
...
assign tmp_user_V_fu_321_p1 = s_axis_video_TUSER_int;
