...
//PORTS
      ...
      bit  [94 : 0] emio_gpio_i;
      bit  [94 : 0] emio_gpio_o;
      bit  [94 : 0] emio_gpio_t;
      bit  emio_i2c0_scl_i;
      bit  emio_i2c0_scl_o;
      bit  emio_i2c0_scl_t;
      bit  emio_i2c0_sda_i;
...
//PARAMETERS
      ...
      parameter C_NUM_F2P_1_INTR_INPUTS = 5;
      parameter C_EMIO_GPIO_WIDTH = 95;
...
//REG DECLARATIONS
      ...
      reg dp_video_ref_clk;
      reg dp_video_out_hsync;
      reg dp_video_out_vsync;
      reg [35 : 0] dp_video_out_pixel1;
      reg dp_live_video_de_out;
      reg pl_resetn0;
      reg pl_clk0;
      string ip_name;
      reg disable_port;
...
import "DPI-C" function void ps8_init_c_model();
 ...
 always@(posedge pl_ps_irq1[1])
 begin
  ps8_set_input_pl_ps_irq1(1,1);
end

 always@(negedge pl_ps_irq1[1])
 begin
  ps8_set_input_pl_ps_irq1(1,0);
end

 always@(posedge pl_ps_irq1[2])
 begin
  ps8_set_input_pl_ps_irq1(2,1);
end

 always@(negedge pl_ps_irq1[2])
 begin
  ps8_set_input_pl_ps_irq1(2,0);
end

 always@(posedge pl_ps_irq1[3])
 begin
  ps8_set_input_pl_ps_irq1(3,1);
end

 always@(negedge pl_ps_irq1[3])
 begin
  ps8_set_input_pl_ps_irq1(3,0);
end

 always@(posedge pl_ps_irq1[4])
 begin
  ps8_set_input_pl_ps_irq1(4,1);
end

 always@(negedge pl_ps_irq1[4])
 begin
  ps8_set_input_pl_ps_irq1(4,0);
end
...
import "DPI-C" function void ps8_simulate_single_cycle_dp_video_ref_clk();
