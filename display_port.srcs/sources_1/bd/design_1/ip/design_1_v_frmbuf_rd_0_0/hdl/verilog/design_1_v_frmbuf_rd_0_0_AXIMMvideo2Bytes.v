...
wire   [28:0] zext_ln359_fu_264_p1;
wire   [31:0] empty_fu_268_p1;
reg   [31:0] empty_reg_347;
wire   [29:0] zext_ln346_fu_282_p1;
reg   [29:0] zext_ln346_reg_352;
wire   [15:0] y_fu_291_p2;
reg   [15:0] y_reg_360;
...
wire   [28:0] offset_fu_327_p2;
wire    ap_CS_fsm_state112;
wire    ap_CS_fsm_state108;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state109;
reg   [28:0] offset_0_i_i_i_reg_200;
reg   [15:0] y_0_i_i_i_reg_212;
...
always @ (posedge ap_clk) begin
    if ((~((mul_ln131_loc_out_full_n == 1'b0) | (mul_ln131_loc_empty_n == 1'b0) | (srcImg_V_offset_empty_n == 1'b0) | (real_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        zext_ln346_reg_352[28 : 0] <= zext_ln346_fu_282_p1[28 : 0];
    end
end
...
assign add_ln355_fu_301_p2 = (zext_ln346_reg_352 + zext_ln355_fu_297_p1);
...
assign offset_fu_327_p2 = (zext_ln359_fu_264_p1 + offset_0_i_i_i_reg_200);
...
assign y_fu_291_p2 = (y_0_i_i_i_reg_212 + 16'd1);

assign zext_ln346_fu_282_p1 = tmp_fu_272_p4;
...
assign zext_ln359_fu_264_p1 = lshr_ln_i_fu_254_p4;

always @ (posedge ap_clk) begin
    empty_reg_347[31:14] <= 18'b000000000000000000;
    zext_ln346_reg_352[29] <= 1'b0;
end
